...
# ============================================================
VERSION = "М17.0.1"                     # Текущая версия вашего приложения
...
class CombinedCalculatorApp:
    def __init__(self, root):
        ...
        # ===== ГЛОБАЛЬНЫЙ ОБРАБОТЧИК КОПИРОВАНИЯ ПО СКАН-КОДУ =====
        self.root.bind('<Key>', self.on_global_key_press)
        
        # ===== АВТОПРОВЕРКА ОБНОВЛЕНИЙ ПРИ ЗАПУСКЕ =====
        self.root.after(1000, lambda: check_update_at_startup(self))
